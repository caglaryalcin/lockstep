...
const en = {
  ...
  "footer.links": "Lockstep links",
  "footer.versionAria": "Lockstep version {{version}}",
  "footer.updateAvailable": "v{{version}} available!",
  "footer.updateAria": "Lockstep version {{version}} is available. Open release notes in a new tab.",
  "footer.github": "Open Lockstep on GitHub in a new tab",
  "footer.issue": "Open a new Lockstep issue on GitHub in a new tab",
...
const tr = {
  ...
  "auth.rememberDevice": "Bu cihazı 30 gün hatırla",
  ...
  "footer.links": "Lockstep bağlantıları",
  "footer.versionAria": "Lockstep sürümü {{version}}",
  "footer.updateAvailable": "v{{version}} available!",
  "footer.updateAria": "Lockstep {{version}} sürümü hazır. Sürüm notlarını yeni sekmede aç.",
  "footer.github": "Lockstep'i GitHub'da yeni sekmede aç",
  "footer.issue": "GitHub'da yeni Lockstep issue'su aç",
...
const de = {
  ...
  "nav.viewAllPages": "Alle Seiten anzeigen",
  "auth.eyebrow": "Persönliches Sicherheitscockpit",
  "auth.title": "Weiter mit deinem eigenen Sicherheitsprofil",
  "auth.subtitle": "Behalte Checklisten-Fortschritt, Einstellungen und Schwerpunkte in einem separaten lokalen Benutzerprofil.",
  "auth.panelTitle": "Anmelden",
  "auth.panelSubtitle": "Melde dich an oder erstelle ein Konto, um deinen Fortschritt an deinen Nutzer zu binden.",
  "auth.loginTab": "Anmelden",
  "auth.registerTab": "Konto erstellen",
  "auth.usernameLabel": "Benutzername",
  "auth.usernamePlaceholder": "Beispiel: alex",
  "auth.usernameError": "Der Benutzername muss mindestens 3 Zeichen lang sein.",
  "auth.nameLabel": "Profilname",
  "auth.namePlaceholder": "Beispiel: Alex",
  "auth.nameError": "Bitte gib mindestens 2 Zeichen ein.",
  "auth.passwordLabel": "Passwort",
  "auth.passwordPlaceholder": "Mindestens 6 Zeichen",
  "auth.passwordError": "Das Passwort muss mindestens 6 Zeichen lang sein.",
  "auth.rememberDevice": "Dieses Gerät 30 Tage merken",
  "auth.login": "Anmelden",
  "auth.register": "Konto erstellen",
  "auth.loginError": "Benutzername oder Passwort ist falsch.",
  "auth.registerError": "Dieser Benutzername ist bereits vergeben oder kann nicht verwendet werden.",
  "auth.registrationDisabled": "Die Registrierung neuer Konten ist deaktiviert.",
  "auth.logout": "Abmelden",
  "auth.activeUser": "Aktiver Nutzer",
  "auth.userScopedData": "Einstellungen und Fortschritt werden für diesen Nutzer gespeichert.",
  "auth.profile": "Profil",
  "auth.afterLoginTitle": "Was passiert als Nächstes?",
  "auth.afterLoginBody": "Nach der Anmeldung öffnet sich dein Dashboard mit Fortschritt, Prioritäten und Checklistenstatus, die nur für dieses Konto gespeichert werden.",
  "auth.cardProgress": "Erfasste Checklistenpunkte",
  "auth.cardPrivate": "Serverseitige Speicherung",
  "auth.cardPrivateValue": "Lokal",
  "auth.cardProfile": "Kontobasierter Fortschritt",
  "auth.cardProfileValue": "Nutzer",
  "userProfile.title": "Benutzerprofil",
  "userProfile.subtitle": "Kontodetails und Übersicht über den gespeicherten Fortschritt.",
  "userProfile.username": "Benutzername",
  "userProfile.displayName": "Anzeigename",
  "userProfile.createdAt": "Erstellt",
  "userProfile.lastSeen": "Zuletzt gesehen",
  "userProfile.savedProgress": "Gespeicherter Fortschritt",
  "userProfile.completed": "{{completed}} / {{total}} abgeschlossen",
  "userProfile.accountSettings": "Kontoeinstellungen",
  "userProfile.accountSettingsBody": "Ändere deinen Benutzernamen oder dein Passwort. Das aktuelle Passwort ist erforderlich.",
  "userProfile.currentPassword": "Aktuelles Passwort",
  "userProfile.currentPasswordError": "Gib dein aktuelles Passwort ein, um Änderungen zu speichern.",
  "userProfile.newPassword": "Neues Passwort",
  "userProfile.newPasswordPlaceholder": "Leer lassen, um das aktuelle Passwort zu behalten",
  "userProfile.saveAccount": "Konto speichern",
  "userProfile.updateError": "Das Konto konnte nicht aktualisiert werden. Überprüfe dein aktuelles Passwort und den Benutzernamen.",
  "userProfile.updateSuccess": "Konto aktualisiert.",
  "settings.title": "Einstellungen",
  "settings.theme": "Design",
  "settings.language": "Sprache",
  "settings.data": "Daten",
  "settings.deleteAll": "Alles löschen",
  "settings.close": "Schließen",
  "settings.confirmDelete": "Möchtest du wirklich alle gespeicherten Daten löschen? Dadurch wird dein Fortschritt gelöscht.",
  "footer.links": "Lockstep-Links",
  "footer.versionAria": "Lockstep-Version {{version}}",
  "footer.updateAvailable": "v{{version}} available!",
  "footer.updateAria": "Lockstep-Version {{version}} ist verfügbar. Versionshinweise in einem neuen Tab öffnen.",
  "footer.github": "Lockstep auf GitHub in einem neuen Tab öffnen",
  "footer.issue": "Ein neues Lockstep-Issue auf GitHub in einem neuen Tab öffnen",
  "footer.license": "Lizenz",
  "progress.title": "Dein Fortschritt",
  "progress.completed": "Du hast {{completed}} von {{total}} Punkten abgeschlossen",
  "progress.noStatsTitle": "Noch keine Statistiken",
  "progress.noStatsBody": "Sobald du beginnst, Punkte in den Checklisten abzuhaken, siehst du hier deinen Fortschritt.",
  "progress.noStatsAction": "Starte, indem du unten eine Checkliste auswählst.",
  "progress.chartLabel": "Fortschritt nach Checklisten-Kategorie und Priorität",
  "progress.sectionTip": "{{percent}}% von {{total}} Punkten abgeschlossen.",
  "priority.basic": "Basis",
  "priority.essential": "Essenziell",
  "priority.recommended": "Empfohlen",
  "priority.optional": "Optional",
  "priority.advanced": "Fortgeschritten",
  "priorityActions.title": "Priorisierte Maßnahmen",
  "priorityActions.subtitle": "Unerledigte Punkte mit der größten Wirkung aus deiner Checkliste.",
  "priorityActions.all": "Alle Checklisten",
  "profile.title": "Sicherheitsprofil",
  "profile.suggested": "Vorgeschlagener Fokus",
  "profile.areas": "{{count}} Bereiche",
  "profile.device": "Gerät",
  "profile.risk": "Risiko",
  "profile.focus": "Fokus",
  "profile.mixed": "Gemischt",
  "profile.mobile": "Mobil",
  "profile.desktop": "Desktop",
  "profile.normal": "Normal",
  "profile.elevated": "Erhöht",
  "profile.high": "Hohes Risiko",
  "profile.accounts": "Konten",
  "profile.privacy": "Privatsphäre",
  "profile.money": "Geld",
  "common.items": "{{count}} Punkte",
  "common.done": "Erledigt",
  "common.notStarted": "Noch nicht begonnen",
  "common.impact": "Wirkung",
  "common.effort": "Aufwand",
  "common.high": "Hoch",
  "common.medium": "Mittel",
  "common.low": "Niedrig",
  "common.monthly": "Monatlich",
  "table.resetFilters": "Filter zurücksetzen",
  "table.showFilters": "Filter anzeigen",
  "table.hideFilters": "Filter ausblenden",
  "table.show": "Anzeigen",
  "table.all": "Alle",
  "table.remaining": "Offen",
  "table.completed": "Abgeschlossen",
  "table.filter": "Filter",
  "table.done": "Erledigt?",
  "table.advice": "Empfehlung",
  "table.level": "Stufe",
  "table.details": "Details",
  "table.ignore": "Ignorieren",
  "table.completeLine": "{{done}} von {{total}} ({{percent}}%) abgeschlossen, {{ignored}} ignoriert",
  "checklist.viewFull": "Vollständige Checkliste ansehen",
} as const;
