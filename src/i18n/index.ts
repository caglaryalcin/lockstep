...
const en = {
  ...
  "demo.badge": "Demo",
  "demo.authTitle": "Temporary demo environment",
  "demo.authBody": "Explore Lockstep safely. Shared demo data is restored every day and whenever the server restarts.",
  "demo.defaultCredentials": "Default sign-in:",
  "demo.heroTitle": "Explore a ready-made security profile",
  "demo.heroBody": "Review Lockstep with realistic progress, priorities, and checklist data already in place.",
  "demo.panelTitle": "Enter the demo",
  "demo.panelBody": "Use the configured shared credentials to open the isolated demo workspace.",
  "demo.afterLoginTitle": "Inside the demo",
  "demo.afterLoginBody": "Try the dashboard and checklists freely. Changes stay in memory until the next daily refresh.",
  "demo.cardMemory": "In-memory sample data",
  "demo.profileTitle": "Account changes are unavailable",
  "demo.profileBody": "This shared demo account cannot be changed. Its sample data is restored automatically every day.",
  "demo.refreshComplete": "The demo environment was refreshed. Sample data and preferences were restored; sign in to continue.",
  "demo.sessionExpired": "Your demo session expired. Sign in again to continue.",
  ...
  "auth.demoPasswordPlaceholder": "Demo password",
  "auth.demoPasswordError": "Enter the demo password.",
  "auth.login": "Sign in",
  ...
  "auth.cardPrivateValue": "Local",
  "auth.cardProfile": "Account-based progress",
  "auth.cardProfileValue": "User",
...
const tr = {
  ...
  "demo.badge": "Demo",
  "demo.authTitle": "Geçici demo ortamı",
  "demo.authBody": "Lockstep'i güvenle keşfet. Paylaşımlı demo verileri her gün ve sunucu yeniden başlatıldığında başlangıç durumuna döner.",
  "demo.defaultCredentials": "Varsayılan giriş:",
  "demo.heroTitle": "Hazır bir güvenlik profilini keşfet",
  "demo.heroBody": "Lockstep'i gerçekçi ilerleme, öncelikler ve hazır kontrol listesi verileriyle incele.",
  "demo.panelTitle": "Demoya gir",
  "demo.panelBody": "İzole demo alanını açmak için yapılandırılmış paylaşımlı bilgileri kullan.",
  "demo.afterLoginTitle": "Demonun içinde",
  "demo.afterLoginBody": "Paneli ve listeleri serbestçe dene. Değişiklikler bir sonraki günlük yenilemeye kadar bellekte kalır.",
  "demo.cardMemory": "Bellek içi örnek veri",
  "demo.profileTitle": "Hesap değişiklikleri kullanılamıyor",
  "demo.profileBody": "Bu paylaşımlı demo hesabı değiştirilemez. Örnek verileri her gün otomatik olarak başlangıç durumuna döner.",
  "demo.refreshComplete": "Demo ortamı yenilendi. Örnek veriler ve tercihler başlangıç durumuna döndü; devam etmek için giriş yap.",
  "demo.sessionExpired": "Demo oturumunun süresi doldu. Devam etmek için tekrar giriş yap.",
  ...
  "auth.demoPasswordPlaceholder": "Demo şifresi",
  "auth.demoPasswordError": "Demo şifresini gir.",
  ...
  "auth.registrationDisabled": "Yeni hesap oluşturma devre dışı.",
  ...
  "auth.cardPrivateValue": "Yerel",
  "auth.cardProfile": "Hesap bazlı ilerleme",
  "auth.cardProfileValue": "Kullanıcı",
